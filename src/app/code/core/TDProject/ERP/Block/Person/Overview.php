...
/**
 * TDProject_ERP_Block_Person_Overview
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_ERP_Block_Person_Overview
    ...
    public function prepareGrid()
    {
    	...
    	$grid = new TDProject_Core_Block_Widget_Grid(
    	    $this,
    	    'grid',
    	    $this->translate('person.overview.grid.label.persons')
    	);
    	...
    	$grid->addColumn(
    	    new TDProject_Core_Block_Widget_Grid_Column(
    	    	'personId',
    	    	$this->translate('person.overview.grid.column.label.id'),
    	        10
    	    )
    	);
    	$grid->addColumn(
    	    new TDProject_Core_Block_Widget_Grid_Column(
    	    	'fullName',
    	    	$this->translate('person.overview.grid.column.label.name'),
    	        30
    	    )
    	);
    	$grid->addColumn(
    	    new TDProject_Core_Block_Widget_Grid_Column(
    	    	'email',
    	    	$this->translate('person.overview.grid.column.label.email'),
    	        25
    	    )
    	);
    	$grid->addColumn(
    	    new TDProject_Core_Block_Widget_Grid_Column(
    	    	'phone',
    	     	$this->translate('person.overview.grid.column.label.phone'),
    	        20
    	    )
    	);
    	// add the actions
    	$action = new TDProject_Core_Block_Widget_Grid_Column_Actions(
    		'actions',
    		$this->translate('person.overview.grid.column.label.actions'),
    	    15
    	);
    	$action->addAction(
    	...
    	$action->addAction(
    	    new TDProject_Core_Block_Widget_Grid_Column_Actions_Delete(
    	    	$this->getContext(), 'personId', '?path=/person&method=delete'
    	    )
    	);
