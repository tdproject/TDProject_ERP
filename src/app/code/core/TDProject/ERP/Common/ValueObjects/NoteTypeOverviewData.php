...
/**
 * TDProject_ERP_Common_ValueObjects_NoteTypeOverviewData
 *
 * NOTICE OF LICENSE
 *
...
require_once 'TDProject/ERP/Common/ValueObjects/NoteTypeLightValue.php';
 ...
 */
class TDProject_ERP_Common_ValueObjects_NoteTypeOverviewData
    extends TDProject_ERP_Common_ValueObjects_NoteTypeLightValue
	 ...
	 */
   	...
   	public function isSelected(TechDivision_Lang_Object $value = null) {
   		return $this->getNoteTypeId()->equals($value);
   	}
}