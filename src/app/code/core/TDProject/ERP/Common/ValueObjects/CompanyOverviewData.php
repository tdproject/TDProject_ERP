...
/**
 * TDProject_ERP_Common_ValueObjects_CompanyOverviewData
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_ERP_Common_ValueObjects_CompanyOverviewData
    extends TDProject_ERP_Common_ValueObjects_CompanyLightValue
	 ...
	 */
   	...
   	public function isSelected(TechDivision_Lang_Object $value = null) {
   		...
   		// check if the company ID's equals
   		return $this->getCompanyId()->equals($value);
   	}
}